describe("cdb.geo.ui.Mobile", function() {
  ...
  describe("with legends, with layer selector, without search", function() {
    ...
    it("should render the attribution", function() {
      ...
      expect(mobile.$el.find(".cartodb-attribution").html()).toBe('<li>©2012 Nokia <a href="http://here.net/services/terms" target="_blank">Terms of use</a></li><li>CartoDB <a href="http://carto.com/attributions" target="_blank">attribution</a></li>');
    });
