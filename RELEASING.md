...
```
git commit -am "Files changed for version 3.13.5"
```
...
```
http://libs.cartocdn.com.s3.amazonaws.com/cartodb.js/v3/3.13.5/cartodb.js
http://libs.cartocdn.com/cartodb.js/v3/3.13.5/cartodb.js
...
```
git flow release finish 3.13.5
git push --all
git push --tags
```
...
For example, if we are in 3.13.5 and we want to go back to 3.12.14
