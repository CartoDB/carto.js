...
```
git flow release start 3.11.37
```
...
```
git commit -am "Files changed for version 3.11.37"
```
...
```
http://libs.cartocdn.com.s3.amazonaws.com/cartodb.js/v3/3.11.37/cartodb.js
http://libs.cartocdn.com/cartodb.js/v3/3.11.37/cartodb.js
...
```
git flow release finish 3.11.37
git push --all
git push --tags
```
...
For example, if we are in 3.11.37 and we want to go back to 3.11.22
