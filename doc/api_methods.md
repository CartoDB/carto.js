...
&#124;_ refreshTime | if is set, the layer is refreshed each refreshTime milliseconds.<br/><br/>See the refreshTime code [example](https://github.com/CartoDB/cartodb.js/blob/develop/examples/refresh_time.html).
...
&#124;_ tooltip | set to false if you want to disable the tooltip (enabled by default).<br/><br/>See the tooltip code [example](https://github.com/CartoDB/cartodb.js/blob/develop/examples/tooltip_createlayer.html).
...
&#124;_ filter | A string, or array of values, that specifies the type(s) of sublayers to be rendered (eg: `['http', 'mapnik')](http://docs.cartodb.com/cartodb-platform/maps-api/mapconfig/#layergroup-configurations). All non-torque layers (http and mapnik) will be rendered if this option is not present.<br/><br/>For an example of the createaLayers filters code, see [leaflet_sandwich.html](https://github.com/CartoDB/cartodb.js/blob/2983b2fdcef914afdb1f4fdae173471143930452/examples/leaflet_sandwich.html).
