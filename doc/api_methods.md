...
&#124;_ refreshTime | if is set, the layer is refreshed each refreshTime milliseconds.<br/><br/>See a refreshTime code [example](https://github.com/CartoDB/cartodb.js/blob/develop/examples/refresh_time.html).
...
&#124;_ tooltip | set to false if you want to disable the tooltip (enabled by default).<br/><br/>See a tooltip code [example](https://github.com/CartoDB/cartodb.js/blob/develop/examples/tooltip_createlayer.html).
